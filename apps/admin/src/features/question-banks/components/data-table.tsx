...
import { QuestionBanksTableToolbar } from './table-toolbar';
...
export function QuestionBanksDataTable<TData, TValue>({
    columns,
    data,
    pageSize = 10,
}: Props<TData, TValue>) {
    ...
    return (
        <div className="space-y-4">
            <QuestionBanksTableToolbar
                table={table as any as import('@tanstack/react-table').Table<QuestionBank>}
            />
