...
export const competitionSchema = z.object({
    ...
    total_marks: z.coerce.number().min(1, 'Total marks is required').default(100),
    total_questions: z.coerce.number().min(1, { message: 'Total questions is required' }).default(50),
    ...
    prizes: z.array(z.object({
        ...
        description: z.string().optional(),
        cash_prize: z.coerce.number().min(0).optional(),
        worth: z.coerce.number().min(0).optional(),
