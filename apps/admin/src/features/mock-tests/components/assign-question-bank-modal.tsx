...
import { useMockTestQuestionBanks, useAssignMockTestQuestionBanks } from '../hooks/use-mock-tests';
...
export function AssignQuestionBankModal({
    ...
    const { data: assignedBanks, isLoading: isLoadingAssigned } = useMockTestQuestionBanks(mockTestId);

    // Assign mutation
    const { mutate: assignQuestionBanks, isPending: isAssigning } = useAssignMockTestQuestionBanks();
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-2xl max-h-[80vh] flex flex-col">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Select the question banks to assign to this mock test.
                        Questions will be pulled from selected banks during the test.
                    </DialogDescription>
                </DialogHeader>
