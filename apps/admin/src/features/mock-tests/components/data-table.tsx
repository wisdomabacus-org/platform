...
import { MockTestsTableToolbar } from './table-toolbar';
...
export function MockTestsDataTable<TData, TValue>({
  columns,
  data,
  pageSize = 10,
}: Props<TData, TValue>) {
  ...
  return (
    <div className="space-y-4">
      <MockTestsTableToolbar
        table={table as any as import('@tanstack/react-table').Table<MockTest>}
      />
